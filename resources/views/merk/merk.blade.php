        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Data Merk</h5>
                    <a href="/merk/create" class="btn btn-primary mb-3"
                            ...
                            <tbody>
                                @foreach ($merk as $item)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="mb-1">{{ $item->kategori->nama_kategori }}</h6>
                                        </td>
                                        <td class="border-bottom-0">
                                            <h6 class="mb-1">{{ $item->nama_merk }}</h6>
                                        </td>
                                        <td class="border-bottom-0 text-center">
                                            <div>
                                                <a href="#" class="text-dark me-2" title="Edit"><i class="ti ti-eye" style="font-size: 1.5rem;"></i>
                                                </a>
                                                <a href="{{ route('merk.edit', $item->id) }}" class="text-primary me-2"
                                                    title="Edit">
